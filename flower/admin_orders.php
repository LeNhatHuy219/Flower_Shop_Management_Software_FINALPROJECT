...
// 1. Kiểm tra đăng nhập Admin/Staff
...
<section class="placed-orders">
   ...
   <div class="filter-tabs">
        <a href="admin_orders.php" class="<?php echo (!isset($_GET['filter_payment']) && !isset($_GET['filter_delivery'])) ? 'active' : ''; ?>">All</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.view-details-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            document.getElementById('modal_delete_link').href = 'admin_orders.php?delete=' + data.orderId;
