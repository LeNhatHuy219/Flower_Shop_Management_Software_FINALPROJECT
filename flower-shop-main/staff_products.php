...
if(isset($_GET['delete'])){
   ...
   header('location:staff_product.php');
   exit();
}
         ...
         <tbody>
            ...
            <tr class="product-row" 
               ...
               <td class="actions">
                  ...
                  <a href="staff_product.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">delete</a>
               </td>
            </tr>
            <?php
               }
